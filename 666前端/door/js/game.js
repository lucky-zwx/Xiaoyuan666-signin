...
function linkChangey(){
	if(yourMessage.value==""){
		yourLink.value = "http://www.xiaoyuan666.com/door/index.html";
	}else{
		yourLink.value = "http://www.xiaoyuan666.com/door/index.html#"+encodeURIComponent(encryptString(yourMessage.value));
	}
};
